import base64, os, cv2, numpy as np, runpod
...
# Use cached models baked into the image
app = FaceAnalysis(name=DET_NAME, root=INSIGHTFACE_HOME)
app.prepare(ctx_id=0, det_size=(DET_SIZE, DET_SIZE))

swapper_path = os.path.join(INSIGHTFACE_HOME, "models", "inswapper_128.onnx")
swapper = get_model(swapper_path, download=False)
